...
function renderAvalibleRewards() {
    return(
...
<Text style={{color:COLORS.primary, ...FONTS.h2}}>Available Rewards</Text>
<View style={{
    marginTop:5,
    padding:SIZES.base,
...
{/* Calories */}
<Text style={{marginTop:3, color:appTheme.textColor, ...FONTS.body3}}>{item.calories}</Text>
{/* Button */}
<CustomButton
label="Order Now"
